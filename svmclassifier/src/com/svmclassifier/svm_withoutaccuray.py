...
class Training():
    ...
    def create_database(self):
        dict_path = r'C:\Users\bharadwaj\Desktop\masquerade-data\dictpath'
        database = {}
        word_id = 0
        files = [file for file in glob.glob(dict_path + '/**/*', recursive=True)]
    ...
    def calculate_testing_metrics(self,predict_output_df , user_no):
        ...
        tn, fp, fn, tp = confusion_matrix(actual_df, predict_output_df).ravel()
        print(tn,fp,fn,tp)
        print(confusion_matrix(actual_df, predict_output_df))
